...
using admin.Blazor.WebApp.Client.Menus;
...
public class adminBlazorClientModule : AbpModule
{
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(adminBlazorClientModule).Assembly;
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<adminBlazorClientModule>();
        });
    }
}
